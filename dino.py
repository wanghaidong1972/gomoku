...
class DinoAgent:
    def __init__(self, env):  # takes game as input for taking actions
        self._env = env;
        self.jump();  # to start the game, we need to jump once

    def is_running(self):
        return self._env.get_playing()

    def is_crashed(self):
        return self._env.get_crashed()
...
def grab_screen(_driver):
    image_b64 = _driver.execute_script("canvasRunner = document.getElementById('runner-canvas'); return canvasRunner.toDataURL().substring(22)")
